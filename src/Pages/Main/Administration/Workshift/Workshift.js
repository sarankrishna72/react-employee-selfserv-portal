...
import { WorkshiftTableData } from '../../../../MockData/AdministrationTableData';
...
const Workshift = ({title}) => {
    ...
    useEffect(() => {
      let data = new TableModel(
        {
          responsive:  true,   
          tableBody: buildBody(WorkshiftTableData.data), 
          tableHeader: buildHeader(WorkshiftTableData.maping)
        }
      )
          ...
          <section id='workshift' className='py-4'>
              <div className='flex max-sm:block justify-between mb-4 '>
                  ...
                  <div className='flex flex-wrap gap-4 '>
                      <Button classes={'min-w-[150px] shrink-0'} btnType={'primary'}>Add Workshift</Button>
                  </div>
              </div>
